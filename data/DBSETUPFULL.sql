...
(
    ...
    DISPONIBILIDAD CHAR(1) CONSTRAINT DISP_RESTAURANTE_EXISTE NOT NULL,
    ...
    CONSTRAINT CK_DISP_RESTAURANTE CHECK (DISPONIBILIDAD IN ('0','1'))
);
...
CREATE TABLE MENU
(
    NOMBRE VARCHAR(50) CONSTRAINT NOMBRE_MENU_EXISTE NOT NULL,
    NOMBRE_RESTAURANTE VARCHAR(50) CONSTRAINT RESTAURANTE_DE_MENU_EXISTE NOT NULL,
...
(
    NOMBRE_MENU VARCHAR(50) CONSTRAINT NOMBRE_MENU_PERT_EXISTE NOT NULL,
    ID_PLATO INTEGER CONSTRAINT PLATO_PERTE_A_MENU_EXISTE NOT NULL,
    NOMBRE_RESTAURANTE VARCHAR(50) CONSTRAINT RESTAURANTE_PERT_A_MENU_EXISTE NOT NULL,
