...
SELECT VALOR,ENTREGADO,TIEMPO,FECHA_INICIO,PERSONALIZABLE,PAGADA,CANTIDAD_MAXIMA,FECHA_FIN,NOMBRE_RESTAURANTE,TRADUCCION,DISPONIBILIDAD,PRECIO,TIPO,COSTO,MESA,FECHA,DESCRIPCION,IDUSUARIO,NUMEROCUENTA,ID_PRODUCTO,CANTIDAD,U.NOMBRE,P.NOMBRE AS NOMBRE_PRODUCTO  FROM (PEDIDO_PROD NATURAL INNER JOIN INFO_PROD_REST), PRODUCTO P,USUARIO U,  CUENTA WHERE ID_PRODUCTO=P.ID AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA  AND NOMBRE_RESTAURANTE = 'Wikibox'AND FECHA<=TO_DATE('2016-10-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2016-10-23 07:00:00', 'yyyy-MM-dd hh24:mi:ss')   ORDER BY PRECIO DESC;
SELECT VALOR,ENTREGADO,TIEMPO,FECHA_INICIO,PERSONALIZABLE,PAGADA,CANTIDAD_MAXIMA,FECHA_FIN,NOMBRE_RESTAURANTE,TRADUCCION,DISPONIBILIDAD,PRECIO,TIPO,COSTO,MESA,FECHA,DESCRIPCION,IDUSUARIO,NUMEROCUENTA,ID_PRODUCTO,CANTIDAD,U.NOMBRE,P.NOMBRE AS NOMBRE_PRODUCTO  FROM (PEDIDO_PROD NATURAL INNER JOIN INFO_PROD_REST), PRODUCTO P,USUARIO U,  CUENTA WHERE ID_PRODUCTO=P.ID AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA  AND NOMBRE_RESTAURANTE = 'Wikibox'AND FECHA<=TO_DATE('2017-08-13 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2017-08-12 07:00:00', 'yyyy-MM-dd hh24:mi:ss')   ORDER BY PRECIO DESC;
SELECT VALOR,ENTREGADO,TIEMPO,FECHA_INICIO,PERSONALIZABLE,PAGADA,CANTIDAD_MAXIMA,FECHA_FIN,NOMBRE_RESTAURANTE,TRADUCCION,DISPONIBILIDAD,PRECIO,TIPO,COSTO,MESA,FECHA,DESCRIPCION,IDUSUARIO,NUMEROCUENTA,ID_PRODUCTO,CANTIDAD,U.NOMBRE,P.NOMBRE AS NOMBRE_PRODUCTO  FROM (PEDIDO_PROD NATURAL INNER JOIN INFO_PROD_REST), PRODUCTO P,USUARIO U,  CUENTA WHERE ID_PRODUCTO=P.ID AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA  AND NOMBRE_RESTAURANTE = 'Wikibox'AND FECHA<=TO_DATE('2017-08-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2016-08-07 07:00:00', 'yyyy-MM-dd hh24:mi:ss')   ORDER BY PRECIO DESC, COSTO DESC;
SELECT VALOR,ENTREGADO,TIEMPO,FECHA_INICIO,PERSONALIZABLE,PAGADA,CANTIDAD_MAXIMA,FECHA_FIN,NOMBRE_RESTAURANTE,TRADUCCION,DISPONIBILIDAD,PRECIO,TIPO,COSTO,MESA,FECHA,DESCRIPCION,IDUSUARIO,NUMEROCUENTA,ID_PRODUCTO,CANTIDAD,U.NOMBRE,P.NOMBRE AS NOMBRE_PRODUCTO  FROM (PEDIDO_PROD NATURAL INNER JOIN INFO_PROD_REST), PRODUCTO P,USUARIO U,  CUENTA WHERE ID_PRODUCTO=P.ID AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA  AND NOMBRE_RESTAURANTE = 'Nlounge'AND FECHA<=TO_DATE('2017-03-01 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2016-08-29 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND  FECHA_FIN<TO_DATE('2017-11-25', 'yyyy-MM-dd hh24:mi:ss')   ORDER BY ID_PRODUCTO DESC, MESA ASC, TIEMPO ASC;

SELECT TIPO,COUNT(*)  FROM (PEDIDO_PROD NATURAL INNER JOIN INFO_PROD_REST), PRODUCTO P,USUARIO U,  CUENTA WHERE ID_PRODUCTO=P.ID AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA  AND NOMBRE_RESTAURANTE<'Nlounge' AND NOMBRE_RESTAURANTE>'Nlounge' AND FECHA<=TO_DATE('2017-07-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2017-06-08 07:00:00', 'yyyy-MM-dd hh24:mi:ss') GROUP BY TIPO HAVING COUNT(*)>10 ORDER BY TIPO DESC;
SELECT TIPO, IDUSUARIO,COUNT(*)  FROM (PEDIDO_PROD NATURAL INNER JOIN INFO_PROD_REST), PRODUCTO P,USUARIO U,  CUENTA WHERE ID_PRODUCTO=P.ID AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA  AND NOMBRE_RESTAURANTE<'Nlounge' AND NOMBRE_RESTAURANTE>'Nlounge' AND FECHA<=TO_DATE('2017-07-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2016-08-07 07:00:00', 'yyyy-MM-dd hh24:mi:ss') GROUP BY TIPO, IDUSUARIO  ORDER BY COUNT(*) DESC, IDUSUARIO ASC;
SELECT IDUSUARIO,AVG(VALOR)  FROM (PEDIDO_PROD NATURAL INNER JOIN INFO_PROD_REST), PRODUCTO P,USUARIO U,  CUENTA WHERE ID_PRODUCTO=P.ID AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA  AND NOMBRE_RESTAURANTE<'Nlounge' AND NOMBRE_RESTAURANTE>'Nlounge' AND FECHA<=TO_DATE('2017-08-07 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2017-08-05 07:00:00', 'yyyy-MM-dd hh24:mi:ss') GROUP BY IDUSUARIO HAVING AVG(VALOR)<=1000 ;

SELECT IDUSUARIO,COUNT(*)  FROM  PEDIDO_MENU PM, MENU M ,USUARIO U, CUENTA   WHERE M.NOMBRE=PM.NOMBRE_MENU AND M.NOMBRE_RESTAURANTE=PM.NOMBRE_RESTAURANTE AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA AND PM.NOMBRE_RESTAURANTE = 'Nlounge' AND FECHA<=TO_DATE('2017-06-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2016-08-07 07:00:00', 'yyyy-MM-dd hh24:mi:ss') GROUP BY IDUSUARIO  ORDER BY IDUSUARIO ASC;
 SELECT VALOR,ENTREGADO,NOMBRE_MENU,PAGADA,PRECIO,COSTO,MESA,FECHA,IDUSUARIO,NUMEROCUENTA,CANTIDAD,U.NOMBRE  FROM  PEDIDO_MENU PM, MENU M ,USUARIO U, CUENTA   WHERE M.NOMBRE=PM.NOMBRE_MENU AND M.NOMBRE_RESTAURANTE=PM.NOMBRE_RESTAURANTE AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA AND PM.NOMBRE_RESTAURANTE = 'Nlounge' AND FECHA<=TO_DATE('2017-08-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2016-08-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND MESA=10   ORDER BY NOMBRE_MENU DESC;
 
SELECT VALOR,COUNT(*)  FROM  PEDIDO_MENU PM, MENU M ,USUARIO U, CUENTA   WHERE M.NOMBRE=PM.NOMBRE_MENU AND M.NOMBRE_RESTAURANTE=PM.NOMBRE_RESTAURANTE AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA AND PM.NOMBRE_RESTAURANTE<'Wikibox' AND PM.NOMBRE_RESTAURANTE>'Wikibox'  AND FECHA<=TO_DATE('2017-08-02 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2017-07-26 07:00:00', 'yyyy-MM-dd hh24:mi:ss') GROUP BY VALOR  ORDER BY VALOR DESC;
SELECT IDUSUARIO,MAX(VALOR)  FROM  PEDIDO_MENU PM, MENU M ,USUARIO U, CUENTA   WHERE M.NOMBRE=PM.NOMBRE_MENU AND M.NOMBRE_RESTAURANTE=PM.NOMBRE_RESTAURANTE AND U.ID=IDUSUARIO AND NUMEROCUENTA=NUMERO_CUENTA AND PM.NOMBRE_RESTAURANTE<'Nlounge' AND PM.NOMBRE_RESTAURANTE>'Nlounge'  AND FECHA<=TO_DATE('2017-08-30 07:00:00', 'yyyy-MM-dd hh24:mi:ss') AND FECHA>=TO_DATE('2017-08-07 07:00:00', 'yyyy-MM-dd hh24:mi:ss') GROUP BY IDUSUARIO HAVING NOT (MAX(VALOR)<='500') 
