...
--RFC1
 ...
 --RFC2
SELECT P.NOMBRE_MENU,CAPACIDAD,INGRESOESPECIAL,ABIERTAACTUALMENTE,PAG_WEB,PAGADA,NOMBRE_RESTAURANTE,CAPACIDADOCUPADA,FECHA,
    MESA,IDUSUARIO,NUMERO_CUENTA,CANTIDAD,P.ID_PRODUCTO,Z.NOMBRE,ID_REPRESENTANTE 
FROM ZONA Z, RESTAURANTE, MESA, CUENTA,  (SELECT * FROM PEDIDO_PROD NATURAL FULL OUTER JOIN PEDIDO_MENU) P 
