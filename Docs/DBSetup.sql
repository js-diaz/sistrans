...
(
    ...
    FOREIGN KEY (ID_PLATO, NOMBRE_RESTAURANTE) REFERENCES INFO_PROD_REST(ID_PLATO, NOMBRE_RESTAURANTE)
);
...
(
    ...
    FOREIGN KEY IN_INGREDIENTE REFERENCES INGREDIENTE(ID)
);
...
(
    ID_INGREDIENTE INTEGER NOT NULL,
    NOMBRE_RESTAURANTE VARCHAR(20) NOT NULL,
    PRECIO_ADICION DOUBLE,
    PRECIO_SUSTITUTO DOUBLE,
