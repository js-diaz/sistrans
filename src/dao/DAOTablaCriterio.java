...
//	}
	...
	public List<ContenedoraInformacion> generarListaFiltradaProductos(
		...
		//Empieza la creación de los datos del query
		//El from debería ser con ZONA, RESTAURANTE, INFO_PROD_REST, PEDIDO_PROD, MENU, PEDIDO_MENU, CUENTA. Se busca una unión de lo que respecta a producto y menú. En una tabla aparte.
		String from ="FROM (SELECT PRODUCTO.*, INFO_PROD_REST.*, RESTAURANTE.PAG_WEB, RESTAURANTE.ID_REPRESENTANTE, CATEGORIA_PRODUCTO.NOMBRE_CATEGORIA"
				+ "FROM PRODUCTO, RESTAURANTE,  INFO_PROD_REST, CATEGORIA_PRODUCTO"
				+ "WHERE PRODUCTO.ID = CATEGORIA_PRODUCTO.ID_PRODUCTO AND PRODUCTO.ID = INFO_PROD_REST.ID_PRODUCTO AND RESTAURANTE.NOMBRE = INFO_PROD_REST.NOMBRE_RESTAURANTE ";
		String select="SELECT ";
		String groupBy="";
		String orderBy="";
		String where=""; 
